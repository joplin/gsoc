...
Instructions for students[​](#instructions-for-students "Direct link to Instructions for students")
---------------------------------------------------------------------------------------------------
...
General instructions[​](#general-instructions "Direct link to General instructions")
------------------------------------------------------------------------------------
...
Recommended steps[​](#recommended-steps "Direct link to Recommended steps")
---------------------------------------------------------------------------
...
3.  Take a look at the [list of ideas](/help/dev/gsoc/gsoc2020/ideas). You can have you own idea added by posting it in the [Features category](https://discourse.joplinapp.org/c/features)
...
Student proposal guidelines[​](#student-proposal-guidelines "Direct link to Student proposal guidelines")
---------------------------------------------------------------------------------------------------------
...
> 
> If you have other commitments during GSoC, such as a job, vacation, exams, internship, seminars, or papers to write, disclose them here. GSoC should be treated like a full-time job, and we will expect approximately 40 hours of work per week. _If you have conflicts, explain how you will work around them._ If you are found to have conflicts which you did not disclose, you may be failed.
> 
...
> 
> _Tell us if you are submitting proposals to other organizations, and whether or not you would choose Joplin if given the choice._
> 
...
Accepted Students[​](#accepted-students "Direct link to Accepted Students")
---------------------------------------------------------------------------
...
Instructions for mentors[​](#instructions-for-mentors "Direct link to Instructions for mentors")
------------------------------------------------------------------------------------------------

### Ideas[​](#ideas "Direct link to Ideas")
...
### Mentoring[​](#mentoring "Direct link to Mentoring")
...
Ideas[​](#ideas-1 "Direct link to Ideas")
-----------------------------------------

Please see below for a list of project ideas:

[List of ideas](/help/dev/gsoc/gsoc2020/ideas)

[Edit this page](https://github.com/laurent22/joplin/tree/dev/readme/dev/gsoc/gsoc2020/index.md)
...
](/help/dev/spec/voice_typing)[

Next

GSoC 2020 Ideas

](/help/dev/gsoc/gsoc2020/ideas)
